...
// Representation Invariant:  The size of the hashtable remains constant after initialization and is the size of hashSize. Each "bucket" of our hash table will be either pointed to NULL or type ListType.
...
class Table {
 ...
 private:
   ...
   // ListType pointer object used to represent our Table class.
   ListType * hashTable;
